"""
taken from the ftxexchange github - just changed how the api keys were given
to the script. nothing else was changed though, the way i am handling the collection of
trade data is very ugly. i basically check the truthiness of ._trades under the BTC-PERP
key and wait until that deque gets data and then i remove everything from it and load that up.
if i did have to make changes to this it would be a simpler callback or something in asyncio
that would block the method return until we actually got the data we subscribed to.
"""
...
from candelabra.websocket_manager import WebsocketManager
